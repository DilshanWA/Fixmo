...
import com.dilshan.clickfixandroidapp.databinding.ActivityElectricianBinding;
...
public class Electrician extends AppCompatActivity {
    ...
    private ActivityElectricianBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityElectricianBinding.inflate(getLayoutInflater());
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot postSnapshot : dataSnapshot.getChildren()) {
                    ...
                    if (service != null && "Electrician".equals(service.getCategory())) {
        ...
        backArrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Electrician.this, Mainhome.class);
