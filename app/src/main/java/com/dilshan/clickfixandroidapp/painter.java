...
import com.dilshan.clickfixandroidapp.databinding.ActivityPainterBinding;
...
public class painter extends AppCompatActivity {
    private ActivityPainterBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityPainterBinding.inflate(getLayoutInflater());
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot postSnapshot : dataSnapshot.getChildren()) {
                    ...
                    if (service != null && "Painter".equals(service.getCategory())) {
       ...
       backArrow.setOnClickListener(new View.OnClickListener() {
           ...
           public void onClick(View view) {
               Intent intent = new Intent(painter.this, Mainhome.class);
